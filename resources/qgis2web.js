...
map.getView().fit([3357457.286457, -1965710.249332, 3366756.163456, -1960527.406415], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">©CUT Geospatial Society 2024</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (80 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This web map was designed to show Students Accomodation Survey in Chinhoyi Urban';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_Final_Studentsaccomodationsurveydata_1,
    colName: 'Facilities',
    zoom: 10,
    collapsed: true,
    map: map
